...
class Container_621cefd39c extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_621cefd39c $container)
			{
	...
	public function createServiceContainer(): Container_621cefd39c
	{
		return $this;
	}
