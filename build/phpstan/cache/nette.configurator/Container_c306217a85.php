...
class Container_c306217a85 extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_c306217a85 $container)
			{
	...
	public function createServiceContainer(): Container_c306217a85
	{
		return $this;
	}
