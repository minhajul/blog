...
class Container_bf5990b82d extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_bf5990b82d $container)
			{
	...
	public function createServiceContainer(): Container_bf5990b82d
	{
		return $this;
	}
