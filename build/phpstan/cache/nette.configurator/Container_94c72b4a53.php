...
// source: phar:///Users/minhajul/Code/personal/blog/vendor/phpstan/phpstan/phpstan.phar/src/PhpDoc/../../conf/config.stubValidator.neon
// source: array
...
class Container_94c72b4a53 extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0574']],
	];
	...
	public function createService042(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			[
				...
				'/Users/minhajul/Code/personal/blog/stubs/Array_.stub',
				'/Users/minhajul/Code/personal/blog/stubs/ArrayItem.stub',
			],
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_94c72b4a53 $container)
			{
	...
	public function createService065(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar:///Users/minhajul/Code/personal/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.stubValidator.neon',
			],
			null,
			[
				'phar:///Users/minhajul/Code/personal/blog/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService072(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			[
				'phar:///Users/minhajul/Code/personal/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'/Users/minhajul/Code/personal/blog/phpstan.neon',
				'phar:///Users/minhajul/Code/personal/blog/vendor/phpstan/phpstan/phpstan.phar/src/PhpDoc/../../conf/config.stubValidator.neon',
			],
			$this->getParameter('analysedPaths'),
			['/Users/minhajul/Code/personal/blog'],
	...
	{
		return new Larastan\Larastan\Methods\BuilderHelper($this->getService('reflectionProvider'), false, $this->getService('0480'));
	}
	...
	public function createService0574(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	public function createServiceContainer(): Container_94c72b4a53
	{
		return $this;
	}
	...
	{
		return $this->getService('0574')->create();
	}
