<x-app-layout>
    <div class="py-6 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-10">
        <div class="relative max-w-4xl mx-auto">
            ...
            <ul role="list"
                class="py-10 grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-2 lg:grid-cols-3 sm:gap-x-6 xl:gap-x-8">
                    ...
                    <li class="relative">
                        <div
                            ...
                            <img class="object-cover pointer-events-none group-hover:opacity-75"
                                 x-intersect="$el.classList.add('scale')" src="{{ $gallery->image_url }}" alt="">
