...
<meta name="twitter:title" content="{{ $setting && $setting->site_title ? $setting->site_title : "Minimal Blog For Personal Use"  }}">
<meta name="twitter:description" content="{{ $setting && $setting->site_description ? $setting->site_description : "Minimal Blog For Personal Use"  }}">
<meta name="twitter:image" content="{{ $setting && $setting->logoUrl() ? $setting->logoUrl() : '#' }}">
<meta name="twitter:creator" content="@">

<meta property="og:url" content="{{ route('home') }}">
<meta property="og:type" content="blog">
<meta property="og:title" content="{{ $setting && $setting->site_title ? $setting->site_title : "Minimal Blog For Personal Use"  }}">
<meta property="og:description" content="{{ $setting && $setting->site_description ? $setting->site_description : "Minimal Blog For Personal Use"  }}">
