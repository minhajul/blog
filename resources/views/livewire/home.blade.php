<div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 lg:py-10">
    <div class="max-w-2xl mx-auto text-center py-6 px-4 sm:py-10 sm:px-6 lg:px-8">
        <div class="grid place-items-center">
            <h2 class="mb-5 animate-move-bg bg-gradient-to-r from-indigo-500 via-pink-500 to-indigo-500 bg-[length:400%] bg-clip-text text-3xl lg:text-4xl font-bold text-transparent">
                Search From Blog
            </h2>
        </div>
    ...
    <div class="max-w-lg mx-auto lg:max-w-none">
        <div class="grid gap-5 lg:grid-cols-3">
            @forelse($blogs as $blog)
                <div class="bg-surface mb-5 flex flex-col rounded-md shadow-md overflow-hidden">
                    <div class="shrink-0">
